...
- Occupation: Executive, desktop job (sedentary most of the day)
...
- Protein-forward eating, prioritized above hitting exact carb/fat numbers — the goal is losing fat while keeping the muscle you have at 58
...
## Pace to goal
14 lb at ~1 lb/week ≈ 14 weeks → roughly **late November 2026**. That's a sound, muscle-preserving pace for a 58-year-old lifting every other day — this is not an aggressive or unrealistic target, it's the right speed. A faster cut (~1,600 kcal/day) is possible but raises the risk of muscle loss and burnout at your training frequency, so it's not the default recommendation.

## Food preferences / restrictions
_(Fill this in — I don't have it yet, and it materially changes what I recommend.)_
- Likes:
- Dislikes:
- Allergies/intolerances:
- Cultural staples to build meals around (e.g., beans, corn tortillas, nopales, salsas, lean meats, fish, avocado):
- Typical eating window / any fasting preference:
- Restaurants/meals you eat often (helps me estimate faster):

## Sample day at 1,850 kcal / 180g protein / 60g fat / 140g carbs
- **Breakfast:** 4 eggs + 1 whole egg extra white, or Greek yogurt (1.5 cups) with berries — ~40g protein
- **Lunch:** 8oz grilled chicken or fish + 1 cup beans or rice + big salad/veg — ~50g protein
- **Snack:** Protein shake or cottage cheese + fruit — ~30g protein
- **Dinner:** 6–8oz lean protein (fish, chicken, lean beef) + nopales or roasted veg + small portion of corn tortillas or rice — ~50g protein
- Adjust portions to hit the day's numbers; swap freely as long as protein and calories land close.
